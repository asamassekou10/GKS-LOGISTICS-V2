...
(function() {
  ...
  const pricingMatrix = {
    air: {
      // From/To Mali (Bamako) - Realistic pricing for 100-1,000 kg shipments
      'mali-france': { baseRate: 4.0, minCharge: 75, volumetricFactor: 167 },
      'france-mali': { baseRate: 4.0, minCharge: 75, volumetricFactor: 167 },
      'mali-turkey': { baseRate: 3.5, minCharge: 60, volumetricFactor: 167 },
      'turkey-mali': { baseRate: 3.5, minCharge: 60, volumetricFactor: 167 },
      'mali-dubai': { baseRate: 4.0, minCharge: 70, volumetricFactor: 167 },
      'dubai-mali': { baseRate: 4.0, minCharge: 70, volumetricFactor: 167 },
      'mali-usa': { baseRate: 6.0, minCharge: 120, volumetricFactor: 167 },
      'usa-mali': { baseRate: 6.0, minCharge: 120, volumetricFactor: 167 },
      'mali-senegal': { baseRate: 3.0, minCharge: 45, volumetricFactor: 167 },
      'senegal-mali': { baseRate: 3.0, minCharge: 45, volumetricFactor: 167 },
      'mali-ivorycoast': { baseRate: 2.8, minCharge: 42, volumetricFactor: 167 },
      'ivorycoast-mali': { baseRate: 2.8, minCharge: 42, volumetricFactor: 167 },
      'mali-burkinafaso': { baseRate: 2.5, minCharge: 38, volumetricFactor: 167 },
      'burkinafaso-mali': { baseRate: 2.5, minCharge: 38, volumetricFactor: 167 },
      'mali-guinea': { baseRate: 2.8, minCharge: 42, volumetricFactor: 167 },
      'guinea-mali': { baseRate: 2.8, minCharge: 42, volumetricFactor: 167 },
      'mali-niger': { baseRate: 2.5, minCharge: 38, volumetricFactor: 167 },
      'niger-mali': { baseRate: 2.5, minCharge: 38, volumetricFactor: 167 },
    ...
    sea: {
      // From/To Mali (Bamako) (via ports) - Realistic pricing for LCL shipments
      'mali-france': { baseRate: 0.65, minCharge: 200, volumetricFactor: 1000, containerRate: 2400 },
      'france-mali': { baseRate: 0.65, minCharge: 200, volumetricFactor: 1000, containerRate: 2400 },
      'mali-turkey': { baseRate: 0.70, minCharge: 195, volumetricFactor: 1000, containerRate: 2100 },
      'turkey-mali': { baseRate: 0.70, minCharge: 195, volumetricFactor: 1000, containerRate: 2100 },
      'mali-dubai': { baseRate: 0.80, minCharge: 210, volumetricFactor: 1000, containerRate: 1750 },
      'dubai-mali': { baseRate: 0.80, minCharge: 210, volumetricFactor: 1000, containerRate: 1750 },
      'mali-usa': { baseRate: 0.90, minCharge: 240, volumetricFactor: 1000, containerRate: 2900 },
      'usa-mali': { baseRate: 0.90, minCharge: 240, volumetricFactor: 1000, containerRate: 2900 },
      'mali-senegal': { baseRate: 0.60, minCharge: 180, volumetricFactor: 1000, containerRate: 2200 },
      'senegal-mali': { baseRate: 0.60, minCharge: 180, volumetricFactor: 1000, containerRate: 2200 },
      'mali-ivorycoast': { baseRate: 0.55, minCharge: 170, volumetricFactor: 1000, containerRate: 2100 },
      'ivorycoast-mali': { baseRate: 0.55, minCharge: 170, volumetricFactor: 1000, containerRate: 2100 },
      'mali-guinea': { baseRate: 0.60, minCharge: 180, volumetricFactor: 1000, containerRate: 2200 },
      'guinea-mali': { baseRate: 0.60, minCharge: 180, volumetricFactor: 1000, containerRate: 2200 },
    ...
    land: {
      // West Africa Regional - Mali (Bamako) origin - Realistic pricing for 100-1,000 kg
      'mali-senegal': { baseRate: 0.06, minCharge: 100, volumetricFactor: 300 },
      'senegal-mali': { baseRate: 0.06, minCharge: 100, volumetricFactor: 300 },
      'mali-ivorycoast': { baseRate: 0.06, minCharge: 100, volumetricFactor: 300 },
      'ivorycoast-mali': { baseRate: 0.06, minCharge: 100, volumetricFactor: 300 },
      'mali-burkinafaso': { baseRate: 0.04, minCharge: 80, volumetricFactor: 300 },
      'burkinafaso-mali': { baseRate: 0.04, minCharge: 80, volumetricFactor: 300 },
      'mali-guinea': { baseRate: 0.05, minCharge: 90, volumetricFactor: 300 },
      'guinea-mali': { baseRate: 0.05, minCharge: 90, volumetricFactor: 300 },
      'mali-niger': { baseRate: 0.05, minCharge: 90, volumetricFactor: 300 },
      'niger-mali': { baseRate: 0.05, minCharge: 90, volumetricFactor: 300 },
